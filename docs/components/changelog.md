...
Parses conventional commit-based release notes (as generated by semantic-release or git-cliff) into structured Go types. Breaking changes are highlighted prominently so consumers can assess upgrade risk.
