...
- [Command Constructor Pattern](../concepts/command-constructors.md) — rationale for `NewCmd*` returning `*setup.Command`.
- [Command Middleware System](../concepts/command-middleware.md) — how `Register` wraps `RunE` with middleware.
- [`gtb generate command`](../cli/generate.md) — flag reference for the generator.
- [Migration v0.4 to v0.5](../migration/v0.4-to-v0.5.md) — diff against the previous `AddCommandWithMiddleware` pattern.
