...
- **[go/transport-openapi](https://transport-openapi.go.phpboyscout.uk)**: `Register`, the `WithSpecPath`/`WithDocsPath`/`WithTitle` options, and the embedded Stoplight assets
