---
title: Command Constructors & Tree
description: The NewCmd constructor pattern, composing the command tree, and why constructors return typed commands.
date: 2026-02-16
tags: [components, setup, initialization, bootstrapping]
authors: [Matt Cockayne <matt@phpboyscout.com>]
---

# Command Constructors & Tree
