...
GTB v1.12 completes Phases 1–3 of the [credential-storage-hardening spec](https://gitlab.com/phpboyscout/go-tool-base/-/wikis/specs/0054-credential-storage-hardening). This guide helps existing users and automated pipelines move off plaintext `config.yaml` storage onto one of the two secure modes GTB supports:
...
- [Credentials component reference](../../explanation/components/credentials.md) — `Backend` interface, `Probe`, architecture
