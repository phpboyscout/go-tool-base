...
require (
	...
	gitlab.com/phpboyscout/go/chat-gemini v0.15.0
	gitlab.com/phpboyscout/go/chat-openai v0.15.0
	...
	gitlab.com/phpboyscout/go/forge-bitbucket v0.13.0
	gitlab.com/phpboyscout/go/forge-gitea v0.22.0
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/bedrockruntime v1.60.0 // indirect
	...
	gitlab.com/phpboyscout/go/yamldoc v0.6.0 // indirect
