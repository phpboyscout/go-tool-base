...
var (
	...
	ErrReleaseChannelRequired   = errors.NewSentinel("gtb.generate.release_channel_required", "self-update releases from the project's forge: host the project on a forge, or drop update from --features (a static release channel is go-tool-base #90)")
	ErrDirectChannelWithdrawn   = errors.NewSentinel("gtb.generate.direct_channel_withdrawn", "the direct release channel is withdrawn until its design lands (go-tool-base #90); self-update releases from the project's forge")
