...
var authorSettings = []AuthorSetting{
	...
	{Field: "ConfigLayers", Kind: KindSetting, Flag: "config-layers", Manifest: "properties.config.layers"},
	{Field: "ConfigFormats", Kind: KindSetting, Flag: "config-formats", Manifest: "properties.config.formats"},
	{Field: "ConfigFormat", Kind: KindSetting, Flag: "config-format", Manifest: "properties.config.format"},
...
func skeletonConfigFromManifest(m Manifest) SkeletonConfig {
	...
	return SkeletonConfig{
		...
		ConfigFormats:         m.Properties.Config.Formats,
