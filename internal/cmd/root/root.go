...
import (
	...
	"gitlab.com/phpboyscout/go-tool-base/internal/cmd/attach"
	"gitlab.com/phpboyscout/go-tool-base/internal/cmd/detach"
...
//
//nolint:gochecknoglobals // ldflags injection target (-X ...root.otelAuth); the linker can only set package-level vars
var otelAuth string
