...
func TestValidateCommandName(t *testing.T) {
	...
	tests := []struct {
		...
		// Go reserved words would produce an invalid `package <kw>` and
		// uncompilable output, so they must be rejected (bug #7).
		{name: "go keyword select", input: "select", wantErr: true},
		{name: "go keyword type", input: "type", wantErr: true},
		{name: "go keyword func", input: "func", wantErr: true},
		{name: "go keyword range", input: "range", wantErr: true},
		{name: "go keyword map", input: "map", wantErr: true},
		{name: "go keyword chan", input: "chan", wantErr: true},
		{name: "go keyword go", input: "go", wantErr: true},
		{name: "go keyword for", input: "for", wantErr: true},
		{name: "go keyword if", input: "if", wantErr: true},
		{name: "go keyword var", input: "var", wantErr: true},
		{name: "go keyword const", input: "const", wantErr: true},
		{name: "go keyword interface", input: "interface", wantErr: true},
